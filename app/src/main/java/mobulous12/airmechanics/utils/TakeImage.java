...
public class TakeImage extends Activity
{
	...
	private final String capture_dir = Environment.getExternalStorageDirectory() + "/AirMechaniks/";
	Activity activity;
...
//					finish();
	...
	private String SaveImage(Bitmap finalBitmap) {
		...
		File myDir = new File(root + "/airmechaniks_croped_images");
		myDir.mkdirs();
	...
	private void runCropImage(String path)
	{
		...
		intent.putExtra(CropImage.ASPECT_X, 2);// if the aspect ratio is fixed to ratio 3/2
